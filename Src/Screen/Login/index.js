                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.Texts}>
                        ...
                        <Text style={{
                            fontWeight: '300',
                            marginTop: 10,
                        }}>We'll check if you have an account</Text>
                    </View>
                    ...
                    <View style={{ justifyContent: 'flex-end', flex: 1 }}>
                        <TouchableOpacity disabled={!message} onPress={Continue} style={{ alignItems: 'center', marginBottom: 20 }}>
                            <Text style={{
                                backgroundColor: '#d70f64',
                                width: 370,
                                textAlign: 'center',
                    ...
                    <View style={styles.container}>
                        <View style={styles.input}>
                            ...
                            <View style={styles.email_icon1}>
                                <Text style={{ alignItems: 'center' }}>
                                    <Ionicons name="ios-shield-checkmark" size={34} color="#d70f64" />
                                </Text>
                                <Text style={{
                                    backgroundColor: "#d70f64",
                                    width: 40,
                        ...
                        <View style={{ justifyContent: 'flex-end', flex: 1, marginBottom: 20 }}>
                            {loading ?
                                ...
                                :
                                <TouchableOpacity onPress={loginForm} style={{
                                    alignItems: 'center',
                                }}>
                                    <Text style={{
                                        backgroundColor: '#d70f64',
